...
$getid=$_GET['id'];
$sql="select * from district where district_id='$getid'";
...
$getdistrictid=$_POST['sendid'];

$update="update district set district_name='$getdistrict' where district_id='$getdistrictid'";
...
<input type="hidden" name="sendid" value="<?php echo $row['district_id'];?>" />
<table align="center" border="2"> 
<tr>
<th colspan="2" style="font-size:30px" align="center">UPDATE DISTRICT </th>
</tr>
<tr>
<td>District Name</td>
<td> <input type="text" name="districtname" id="districtname" value="<?php echo $row['district_name'];?>"
 </td> </td></tr>
