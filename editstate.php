...
$getid=$_GET['id'];
$sql="select * from state where state_id='$getid'";
...
$getstateid=$_POST['sendid'];

$update="update state set state_name='$getstate' where state_id='$getstateid'";
...
<input type="hidden" name="sendid" value="<?php echo $row['state_id'];?>" />
<table align="center" border="2"> 
<tr>
<th colspan="2" style="font-size:30px" align="center">UPDATE STATE </th>
</tr>
<tr>
<td>State Name</td>
<td> <input type="text" name="statename" id="statename" value="<?php echo $row['state_name'];?>"
 </td> </td></tr>
