...
if (isset($_POST['Add']))
{
$getdistrict=$_POST['districtname'];
$getstate=$_POST['state'];
$getcountry=$_POST['country'];

 $sql="SELECT * from district where district_name='$getdistrict'";
   ...
   if($count!=1)
   {
    ...
    $sqlinsert="INSERT INTO district(district_id,district_name,state_id,country_id) VALUES ('','$getdistrict','$getstate','$getcountry')";
	
	   $result=mysqli_query($con,$sqlinsert);
   
   if($result==true)
   {
   echo 'District Name successfully Added';
   }
...
<tr>
<th colspan="2" style="font-size:40px"> Add District</th></tr>
<tr>
<td style="font-size:24px">District Name</td>
...
$i=1;
 ...
 <td><?php echo $row['district_name']; ?> </td>
  ...
  <td> 
 <a href="editdistrict.php?id=<?php echo $row['district_id'];?>">Edit</a>|<a href="javascript:void();" onClick="Delete('deletedist.php?id=<?php echo $row['district_id'];?>')">Delete</a>  
 </td>
 </tr>
